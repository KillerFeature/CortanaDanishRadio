...
namespace DanishRadio
{
...

    {
        ...
        public static string SpeakDanish(string text)

        {
            ...
            var ssml = new XDocument(new XElement(
                ...
                new XAttribute(XNamespace.Xml + "lang", "da-DK"), new XElement("voice", new XAttribute("name", "Microsoft Server Speech Text to Speech Voice (da-DK, HelleRUS)"),
